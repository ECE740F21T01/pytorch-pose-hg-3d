...
class opts():
  def __init__(self):
    ...
    self.parser.add_argument('--optim_type', type=str, default='adam')  # TODO SGD for NPU, also need scheduler...?
    ...
    self.parser.add_argument('--grad_clip', type = float, default = None)  # Typical value would be 5.0
